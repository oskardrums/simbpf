...
struct sb_vertex_s
{
    ...
    struct sb_vertex_s * fallthrough;
...
struct sb_vertex_s * sb_graph_vertex(struct sb_graph_s * g, struct sb_vw_s * weight, struct sb_vertex_s * fallthrough_v) __attribute__((nonnull(1)));
